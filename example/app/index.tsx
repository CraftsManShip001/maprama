...
const SCREENS: Entry[] = [
  ...
  { slug: 'native', href: '/native', title: '13. Native engine (M2c)', description: 'engine="native": the Seongsu world as 3D MapLibre buildings in theme colours with a custom layer for roofs (gable / dome), facade windows and details, outlines and the captured flag, themes and time of day, a captured building, map / building presses, a MapOverlay card, map UI, camera presets and a project/unproject round trip.' },
  { slug: 'native-game', href: '/native-game', title: '14. Native engine (M3b)', description: 'engine="native" game systems with 3D models in the custom layer: the example glTF robot walking the simulated location source, the procedural player travelling to near / far presets with a route line and live ETA, 3D drops placed on the route and collected on the way, one of each drop item, a geofence with enter / exit events, the location puck, an occlusion close-up behind a building and 1 / 10 / 50 character crowds.' },
  { slug: 'native-m4', href: '/native-m4', title: '15. Native engine (M4)', description: 'The zoom-out game view (theme.zoomOut none / mapColors / keepGameView) near and beyond the far band, the performance scene of the native design (50 characters, 200 drops, 20 geofences, orbiting camera) and an engine toggle that renders the same scene with engine-web or engine-native.' },
];
