...
const SCREENS: Entry[] = [
  ...
  { slug: 'camera', href: '/camera', title: '10. Camera limits & fitBounds', description: 'minDistanceMeters / maxDistanceMeters in real metres whatever the world scale, a 3,330 m wide view with the fog and shadow ranges stretched to match, fitBounds over 18 pins with dp padding, and the 40° field of view as visibleSpanMeters.' },
