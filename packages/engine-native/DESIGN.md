...
Status: **M2b labels (native label views and character name tags)** integrated with M3b (3D characters and drop
models in the custom layer), M3a (game systems), M2c (diorama look, part 2: custom building layer), procedural worlds
(M2b), M2a (diorama look, part 1) and M1 (map on screen). This package contains:
