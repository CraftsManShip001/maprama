...
inline constexpr std::array<std::string_view, 25> kEngineCommandTypes{
...
inline constexpr std::array<std::string_view, 21> kEngineEventTypes{
    ...
    "infoCard:press", "infoCard:dismiss", "view:change",
};
