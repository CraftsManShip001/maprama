...
const commandSamples = {
  ...
  request_focusOn: { type: 'request', requestId: 'q8', method: 'focusOn', params: { coordinate: ll } },
  request_focusOn_full: {
    type: 'request',
    requestId: 'q9',
    method: 'focusOn',
    params: {
...
const extraCommandCases = [
  ...
  ['focusOn without a target', { type: 'request', requestId: 'q', method: 'focusOn', params: {} }],
  ['focusOn with both targets', { type: 'request', requestId: 'q', method: 'focusOn', params: { coordinate: ll, infoCardId: 'c' } }],
  ['focusOn empty infoCardId', { type: 'request', requestId: 'q', method: 'focusOn', params: { infoCardId: '' } }],
  ['focusOn distance 0', { type: 'request', requestId: 'q', method: 'focusOn', params: { coordinate: ll, distance: 0 } }],
  ['focusOn pitch 90.0001', { type: 'request', requestId: 'q', method: 'focusOn', params: { coordinate: ll, pitch: 90.0001 } }],
  ['focusOn negative heightMeters', { type: 'request', requestId: 'q', method: 'focusOn', params: { coordinate: ll, heightMeters: -1 } }],
  ['focusOn inset string', { type: 'request', requestId: 'q', method: 'focusOn', params: { coordinate: ll, inset: 'yes' } }],
  ['infoCard without content', { type: 'setInfoCard', card: { id: 'c', coordinate: ll } }],
  ['infoCard empty content', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: {} } }],
  ['infoCard unknown anchor', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: { title: 't' }, anchor: 'sky' } }],
  ['infoCard heightMeters 0', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: { title: 't' }, heightMeters: 0 } }],
  ['infoCard unknown icon', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: { title: 't', icon: 'teapot' } } }],
  ['infoCard unknown badge tone', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: { title: 't', badges: [{ text: 'x', tone: 'loud' }] } } }],
  ['infoCard unknown row icon', { type: 'setInfoCard', card: { id: 'c', coordinate: ll, content: { title: 't', rows: [{ text: 'x', icon: 'wifi' }] } } }],
